...
pat = Author.first_or_create(given_name: 'Pat', family_name: 'Shaughnessy')
michael = Author.first_or_create(given_name: 'Michael', family_name: 'Hartl')
sam = Author.first_or_create(given_name: 'Sam', family_name: 'Ruby')


oreilly = Publisher.first_or_create(name: "O'Reilly")
